...
def build_proposal_conv(cfg, mask2d):
    input_size = cfg.MODEL.D3G.FEATPOOL.HIDDEN_SIZE
    hidden_size = cfg.MODEL.D3G.PREDICTOR.HIDDEN_SIZE
    kernel_size = cfg.MODEL.D3G.PREDICTOR.KERNEL_SIZE
    num_stack_layers = cfg.MODEL.D3G.PREDICTOR.NUM_STACK_LAYERS
    output_size = cfg.MODEL.D3G.JOINT_SPACE_SIZE
