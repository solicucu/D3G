import logging
import torch
from d3g.utils.comm import get_world_size
from d3g.utils.imports import import_file
...
def build_dataset(dataset_list, dataset_catalog, cfg, is_train=True):
    ...
    for dataset_name in dataset_list:
        ...
        args["num_clips"] = cfg.MODEL.D3G.NUM_CLIPS
...
def make_data_loader(cfg, is_train=True, is_distributed=False, is_for_period=False):
    ...
    paths_catalog = import_file(
        "d3g.cfg.paths_catalog", cfg.PATHS_CATALOG, True
    )
