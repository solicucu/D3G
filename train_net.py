...
def train(cfg, local_rank, distributed):
    ...
    checkpointer = CheckpointManager(cfg, model, optimizer, scheduler, output_dir, save_to_disk)
    arguments = {"epoch": 1}
    
    if cfg.SOLVER.RESUME:
        arguments = {"epoch": cfg.SOLVER.RESUME_EPOCH}
        weight_path = osp.join(output_dir, "model_last.pth")
...
def main():
    ...
    ckpt = "{}/best_model.pth".format(output_dir)
